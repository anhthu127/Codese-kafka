...
import { createStockTable } from "./repository/create-stock-table.repo";
import { createErrorsLogTable } from "./repository/create-log-table.repo";
...
const getStockTransaction = async (stockCode) => {
  const sql = `select * from stock-price where code='${stockCode}'`;
